            ...
            <h1 class="h1 text-dark text-center"> Login </h1>
                <form method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="password" value="<?php if(isset($_POST['password'])){echo $_POST['password'];}?>"class="form-control" id="exampleInputPassword1">                   
                    </div>
                    <?php if(isset($errors['password'])){echo $errors['password'];}?>
                        <?php if(isset($errors['email-password'])){echo $errors['email-password'];}?>
